            ...
            <tbody>
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td class="<?php echo e($class); ?>"><?php echo e(ucfirst($status)); ?></td>
                    </tr>
...
<?php /**PATH /Users/abubakarsiddik/Documents/studentattendenceapp/resources/views/attendances/history.blade.php ENDPATH**/ ?>