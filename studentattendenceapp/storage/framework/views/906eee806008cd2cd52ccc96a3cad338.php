...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => url('/redirect'),'active' => request()->is('admin-dashboard') || request()->is('teacher-dashboard') || request()->is('student-dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url('/redirect')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->is('admin-dashboard') || request()->is('teacher-dashboard') || request()->is('student-dashboard'))]); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 transition">
                            <div><?php echo e(Auth::check() ? Auth::user()->name : 'Guest'); ?></div>
                            <div class="ms-1">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => url('/redirect'),'active' => request()->is('admin-dashboard') || request()->is('teacher-dashboard') || request()->is('student-dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /Users/abubakarsiddik/Documents/studentattendenceapp/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>